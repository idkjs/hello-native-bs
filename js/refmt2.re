...
[@bs.module "./refmt.js"] external parseREIEx: string => ast = "parseREI";

[@bs.module "./refmt.js"] external parseMLEx: string => ast = "parseML";

[@bs.module "./refmt.js"] external parseMLIEx: string => ast = "parseMLI";

[@bs.module "./refmt.js"] external printRE: ast => string = "printRE";

[@bs.module "./refmt.js"] external printREI: ast => string = "printREI";

[@bs.module "./refmt.js"] external printML: ast => string = "printML";

[@bs.module "./refmt.js"] external printMLI: ast => string = "printMLI";

[@bs.module "./refmtOld.js"] external parseREOldEx: string => ast = "parseRE";

[@bs.module "./refmtOld.js"]
external parseREIOldEx: string => ast = "parseREI";

[@bs.module "./refmtOld.js"] external printREOld: ast => string = "printRE";

[@bs.module "./refmtOld.js"] external printREIOld: ast => string = "printREI";
...
let genErrors = errors =>
  ...
  | [] => (
      UnknownLang,
      UnknownLang,
      "Sorry we don't have much info. Something went very wrong.",
    )
  | [error, ..._] =>
    let thing =
      switch (error) {
...
let refmt = (code, inLang, inType, outLang) => {
  ...
  try({
    ...
    let (trueOut, printedResult) =
      ...
      | (_, Error(error)) =>
        switch (error) {
        | REI(thing) =>
          raise(Failure(Js.Exn.message(thing) |> optionalString))
        | RE(thing) =>
          raise(Failure(Js.Exn.message(thing) |> optionalString))
        | ML(thing) =>
          raise(Failure(Js.Exn.message(thing) |> optionalString))
  ...
  | a => Result.Error(a |> Printexc.to_string)
  };
};